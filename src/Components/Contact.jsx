      ...
      {show && (
        ...
        >
          <motion.div
            ...
            className="bg-gray-900 p-8 rounded-xl shadow-xl border border-green-500 text-center"
          >
            <motion.div
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post("http://localhost:5000/submit-form", data);
      if (res.status === 200) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-800 p-8 rounded-lg shadow-lg relative">
            ...
            <form className="max-w-md mx-auto relative z-0" onSubmit={handleSubmit}>
              {[
                ...
                <div key={name} className="relative z-0 w-full mb-5 group">
                  ...
                  <label
                    htmlFor={name}
                    className="absolute text-sm md:text-lg text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 peer-focus:text-blue-400"
                  >
                    {label}
                  </label>
                </div>
              ...
              <div className="mb-5">
                <textarea
                  ...
                  required
                  className="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm md:text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                />
              </div>
